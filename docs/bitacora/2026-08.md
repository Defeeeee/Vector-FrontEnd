# Bitácora de Vector — agosto de 2026

> **Archivo.** Estas entradas vivían en `AGENTS.md` y se movieron **tal cual, sin
> editar**, el 2026-09-22, cuando ese archivo llegó a 343 KB y dejó de ser algo que un
> agente pudiera leer entero antes de empezar. Lo vigente —arquitectura, invariantes y
> pendientes— está resumido en `AGENTS.md`. Las rutas y afirmaciones de acá describen
> el repo **en la fecha de cada entrada**: verificá contra el código antes de tomarlas
> como actuales.
>
> Incluye, en el medio, la vieja sección "Pasos a seguir (para el próximo agente)", que
> ya no es el backlog: quedó como estaba el 2026-08-17.
